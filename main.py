...
def BHC_AWGN():
    ...
    # plot results
    plot_BER(dB_range, BER_tabular_sarsa, BER_tabular_qlearn, bfd, bench, 'SNR (dB)', name, figure_name)
...
def RM_AWGN():
    ...
    # plot results
    plot_BER(dB_range, BER_tabular_sarsa, BER_tabular_qlearn, bench, bfd, 'SNR (dB)', name, figure_name)
